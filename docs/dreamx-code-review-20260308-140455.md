...
- `React.memo` 包裹节点组件 (`BaseWorkflowNode.displayName = 'BaseWorkflowNode'`)
- `useMemo` 缓存计算结果 (`statusConfig`)
- `useCallback` 稳定事件处理函数 (`handleBack`, `handleZoomIn`, etc.)
- 防抖处理 (视口变化/节点拖拽)
